...
c      PCCL3F(I) = PCCL3F(I) + FLX*SCCL3F(L)*S(I)
c      PCCL2F2(I) = PCCL2F2(I) + FLX*SCCL2F2(L)*S(I)
c      PCCL4(I) = PCCL4(I) + FLX*SCCL4(L)*S(I)
c      PCH3CL(I) = PCH3CL(I) + FLX*SCH3CL(L)*S(I)
c      PMCCL3(I) = PMCCL3(I) + FLX*SMCCL3(L)*S(I)
c      PCL2(I) = PCL2(I) + FLX*SCL2(L)*S(I)
c      PCLO2(I) = PCLO2(I) + FLX*SCLO2(L)*S(I)
c      PHCL(I) = PHCL(I) + FLX*SHCL(L)*S(I)
c      PHOCL(I) = PHOCL(I) + FLX*SHOCL(L)*S(I)
c      PNOCL(I) = PNOCL(I) + FLX*SCLNO(L)*S(I)
c      PCLONO(I) = PCLONO(I) + FLX*SCLONO(L)*S(I)
c      PCLONO2(I) = PCLONO2(I) + FLX*SCLONO2(L)*S(I)
      pn2o5(i) = pn2o5(i) + flx*sn2o5(l)*s(i)
c      pcl2o2(i) = pcl2o2(i) + flx*scl2o2(l)*s(i)
