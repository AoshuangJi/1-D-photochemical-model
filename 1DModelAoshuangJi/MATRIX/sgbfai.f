      integer function isamaxi(n,sx,incx)
c
...
c
   ...
   30 continue
	...
	subroutine sgbfai(abd,lda,n,ml,mu,ipvt,info)
...
c
      real t
      integer i,isamaxi,i0,j,ju,jz,j0,j1,k,kp1,l,lm,m,mm,nm1
c
c
      m = ml + mu + 1
      info = 0
