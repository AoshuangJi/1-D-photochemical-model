...
C
  ...
  11  RHOP(J) = 1.4
   ...
   7  CONTINUE
c      print *, ' conver(J,K) = ', conver
c       print *, 'fsulf(J) = ', fsulf: not the same 

c      print *, 'R =', Rpar  they are the same   
c      print *, 'J = ', J  they are the same
c      print *, 'K = ', K  they are the same 
